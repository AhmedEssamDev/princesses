...
function getMockAbout() {
  ...
  const defaults = {
    ...
    heroSubtitle: 'بدأت رحلتنا في عام 2008 برؤية واضحة لأرقى الفساتين',
    story: 'بدأت Princesses رحلتها in عام 2008 برؤية واضحة: صناعة فساتين تعكس شخصية كل امرأة — أنيقة، مُفصّلة، وفريدة.',
